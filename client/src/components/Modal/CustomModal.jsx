      ...
      <AnimatePresence>
        {isOpen ? (
          <motion.div
            ...
            ${
              darkMode
                ? " bg-[#23252b] text-[#919197]"
                : "  text-[#18191a] bg-[#fcf6eb]"
            } 
          ...
          >
            <div className="w-full flex justify-end ">
              <button
                onClick={onCancel}
                className="text-[#924a4a] hover:text-[#a35a5a]"
              >
            ...
            <div className="flex justify-end py-3 w-full">
              <button
                className="bg-none rounded-md border-2 border-[#924a4a] py-1 mr-4 w-20 px-3 text-sm text-[#a35a5a] hover:border-[#7c3d3d] text-[#924a4a]"
                onClick={onCancel}
              >
                Annuler
              </button>{" "}
